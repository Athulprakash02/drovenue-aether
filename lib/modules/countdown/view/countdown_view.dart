  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final Color accentColor = isLive
          ...
          : const Color(0xFF00FFC2); // Red for live, Cyan for preparing
            ...
            if (!isLive)
              Text(
                ...
                style: TextStyle(
                  ...
                  letterSpacing: 2.0,
                  shadows: <Shadow>[Shadow(color: accentColor, blurRadius: 15)],
            ...
            if (isLive)
              Text(
                ...
                style: TextStyle(
                  ...
                  letterSpacing: 2.0,
                  shadows: <Shadow>[Shadow(color: accentColor, blurRadius: 10)],
                ),
              )
            else
              Container(
